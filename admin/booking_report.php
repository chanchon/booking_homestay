                ...
                <table class="table table-bordered table-hover table-striped" id="example">
                    ...
                    <thead class="thead" >  
                        <tr class="table-dark tr" align="center">
                            <th class="th"scope="col">ลำดับที่</th>
                            <th class="th" scope="col">ชื่อ-นามสกุล</th>
                            <th class="th" scope="col">เบอร์โทรศัพท์</th>
                            <th class="th" scope="col">จำนวนคนที่เข้าพัก</th>
                            <th class="th" scope="col">ที่พัก</th>
                            <th class="th" scope="col">เช็คอิน</th>
                            <th class="th" scope="col">เช็คเอาท์</th>
                            <th class="th" scope="col">แพ็กเกจ</th>
                            <th class="th" scope="col">ห้อง</th>
                        </tr>
                    </thead>
                    <tbody class="tbody">
                        <?php
